...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # nh is number of heads, hs is "head size", and C (number of chhannels) = nh * hs
        # e.g. in GPT-2 (124M), n_head=12, hs=64 so n_head * hs = 768 channels in the Transformer
        qkv = self.c_attn(x)
...
class GPTConfig:
    ...
    vocab_size: int = 50257 # number of tokens: 50,000 BPE merges + 256 byte tokens + 1 for padding (end of text tokeN)
